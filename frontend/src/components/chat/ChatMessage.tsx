...
const ChatMessage: React.FC<ChatMessageProps> = ({message, onReportClick, onDownload}) => {
    const {user} = useAuth()
        ...
        <div className={`${styles.chatMessage} ${styles[message.type]}`}>
            ...
            <div className={styles.messageContentWrapper}>
                <div className={styles.messageHeader}>
                    <span className={styles.messageSender}>{message.type === 'user' ? <span>{user?.username || '사용자'} </span> : 'Assistant'}</span>
